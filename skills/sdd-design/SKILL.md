...
- **Token budget**: Design artifact MUST be under 3,000 tokens (~800 words). Architecture decisions as tables (option | tradeoff | decision). Code snippets only for non-obvious patterns.
